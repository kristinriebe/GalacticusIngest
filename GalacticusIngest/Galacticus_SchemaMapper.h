...
#ifndef Galacticus_Galacticus_SchemaMapper_h
#define Galacticus_Galacticus_SchemaMapper_h
...
namespace Galacticus {
    ...
    class GalacticusSchemaMapper : public SchemaDataMapGenerator  {
    ...
    public:
        GalacticusSchemaMapper();

        GalacticusSchemaMapper(DBAsserter::AsserterFactory * newAssertFac, DBConverter::ConverterFactory * newConvFac);
